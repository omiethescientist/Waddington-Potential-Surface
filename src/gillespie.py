#This code is not mine, it is taken from the sueskind package which is currently broken for version 3.8
#https://github.com/sueskind/gillespie/blob/master/src/_gillespie.py
